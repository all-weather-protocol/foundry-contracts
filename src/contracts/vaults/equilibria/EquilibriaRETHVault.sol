...
contract EquilibriaRETHVault is BaseEquilibriaVault {
    IERC20 public constant RETH = IERC20(0xEC70Dcb4A1EFa46b8F2D97C310C9c4790ba5ffA8);
    ...
    function _zapIn(
        ...
        uint256 currentAllowance = WETH.allowance(address(this), oneInchAggregatorAddress);
        ...
        // zap into pendle
        uint256 shares = super._zapIn(RETH, swappedDaiAmount, minLpOut, guessPtReceivedFromSy, input);
